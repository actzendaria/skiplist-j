...
* @since 1.6
*/
public class MyConcurrentSkipListMap<K,V> extends AbstractMap<K,V>
    ...
    *         or values are null
    */
   public MyConcurrentSkipListMap(Map<? extends K, ? extends V> m) {
       this.comparator = null;
       initialize();
       putAll(m);
   }
    ...
    */
   public MyConcurrentSkipListMap(SortedMap<K, ? extends V> m) {
   ...
   /**
    * Returns a shallow copy of this <tt>MyConcurrentSkipListMap</tt>
    * instance. (The keys and values themselves are not cloned.)
    *
    * @return a shallow copy of this map
    */
   public MyConcurrentSkipListMap<K,V> clone() {
       MyConcurrentSkipListMap<K,V> clone = null;
       try {
           clone = (MyConcurrentSkipListMap<K,V>) super.clone();
   ...
   static final class KeySet<E>
       ...
       public Iterator<E> iterator() {
           if (m instanceof MyConcurrentSkipListMap)
               ...
               return ((MyConcurrentSkipListMap.SubMap<E,Object>)m).keyIterator();
       }
       public boolean equals(Object o) {
           if (o == this)
               return true;
   ...
   static final class Values<E> extends AbstractCollection<E> {
       ...
       public Iterator<E> iterator() {
           if (m instanceof MyConcurrentSkipListMap)
               return ((MyConcurrentSkipListMap<Object,E>)m).valueIterator();
           else
   ...
   /**
    * Submaps returned by {@link MyConcurrentSkipListMap} submap operations
   ...
   static final class SubMap<K,V> extends AbstractMap<K,V>
        ...
        */
       private boolean isBeforeEnd(MyConcurrentSkipListMap.Node<K,V> n) {
           if (n == null)
               return false;
           if (hi == null)
               return true;
        ...
        */
       private MyConcurrentSkipListMap.Node<K,V> loNode() {
           if (lo == null)
               return m.findFirst();
           else if (loInclusive)
        ...
        * most usages need to check bounds
        */
       private MyConcurrentSkipListMap.Node<K,V> hiNode() {
           if (hi == null)
               return m.findLast();
           else if (hiInclusive)
        ...
        */
       private K lowestKey() {
           MyConcurrentSkipListMap.Node<K,V> n = loNode();
           if (isBeforeEnd(n))
               return n.key;
           else
               throw new NoSuchElementException();
       ...
       private K highestKey() {
           MyConcurrentSkipListMap.Node<K,V> n = hiNode();
           if (n != null) {
               K last = n.key;
               if (inBounds(last))
                   return last;
       ...
       /**
        * Submap version of MyConcurrentSkipListMap.getNearEntry
        */
       ...
       public int size() {
           long count = 0;
           for (MyConcurrentSkipListMap.Node<K,V> n = loNode();
                isBeforeEnd(n);
                n = n.next) {
               if (n.getValidValue() != null)
                   ++count;
