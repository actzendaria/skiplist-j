...
* @since 1.6
*/
public class MySecondConcurrentSkipListMap<K,V> extends AbstractMap<K,V>
   ...
   private static final long serialVersionUID = -8627078645895051611L;
    ...
    */
   public MySecondConcurrentSkipListMap() {
    ...
    */
   public MySecondConcurrentSkipListMap(Comparator<? super K> comparator) {
    ...
    *         or values are null
    */
   public MySecondConcurrentSkipListMap(Map<? extends K, ? extends V> m) {
       this.comparator = null;
       initialize();
       putAll(m);
   }
    ...
    */
   public MySecondConcurrentSkipListMap(SortedMap<K, ? extends V> m) {
   ...
   /**
    * Returns a shallow copy of this <tt>MySecondConcurrentSkipListMap</tt>
    * instance. (The keys and values themselves are not cloned.)
    *
    * @return a shallow copy of this map
    */
   public MySecondConcurrentSkipListMap<K,V> clone() {
       MySecondConcurrentSkipListMap<K,V> clone = null;
       try {
           clone = (MySecondConcurrentSkipListMap<K,V>) super.clone();
   ...
   abstract class Iter<T> implements Iterator<T> {
       ...
       public void remove() {
           ...
           MySecondConcurrentSkipListMap.this.remove(l.key);
           lastReturned = null;
       }
   ...
   static final class KeySet<E>
       ...
       public Iterator<E> iterator() {
           if (m instanceof MySecondConcurrentSkipListMap)
               return ((MySecondConcurrentSkipListMap<E,Object>)m).keyIterator();
           else
               return ((MySecondConcurrentSkipListMap.SubMap<E,Object>)m).keyIterator();
       }
       public boolean equals(Object o) {
           if (o == this)
               return true;
   ...
   static final class Values<E> extends AbstractCollection<E> {
       ...
       public Iterator<E> iterator() {
           if (m instanceof MySecondConcurrentSkipListMap)
               return ((MySecondConcurrentSkipListMap<Object,E>)m).valueIterator();
           else
   ...
   static final class EntrySet<K1,V1> extends AbstractSet<Map.Entry<K1,V1>> {
       ...
       public Iterator<Map.Entry<K1,V1>> iterator() {
           if (m instanceof MySecondConcurrentSkipListMap)
               return ((MySecondConcurrentSkipListMap<K1,V1>)m).entryIterator();
           else
   ...
   /**
    * Submaps returned by {@link MySecondConcurrentSkipListMap} submap operations
   ...
   static final class SubMap<K,V> extends AbstractMap<K,V>
       ...
       /** Underlying map */
       private final MySecondConcurrentSkipListMap<K,V> m;
        ...
        */
       SubMap(MySecondConcurrentSkipListMap<K,V> map,
        ...
        */
       private boolean isBeforeEnd(MySecondConcurrentSkipListMap.Node<K,V> n) {
           if (n == null)
               return false;
           if (hi == null)
               return true;
        ...
        */
       private MySecondConcurrentSkipListMap.Node<K,V> loNode() {
           if (lo == null)
               return m.findFirst();
           else if (loInclusive)
        ...
        * most usages need to check bounds
        */
       private MySecondConcurrentSkipListMap.Node<K,V> hiNode() {
           if (hi == null)
               return m.findLast();
           else if (hiInclusive)
        ...
        */
       private K lowestKey() {
           MySecondConcurrentSkipListMap.Node<K,V> n = loNode();
           if (isBeforeEnd(n))
               return n.key;
           else
               throw new NoSuchElementException();
       ...
       private K highestKey() {
           MySecondConcurrentSkipListMap.Node<K,V> n = hiNode();
           if (n != null) {
               K last = n.key;
               if (inBounds(last))
                   return last;
       ...
       /**
        * Submap version of MySecondConcurrentSkipListMap.getNearEntry
        */
       ...
       public int size() {
           long count = 0;
           for (MySecondConcurrentSkipListMap.Node<K,V> n = loNode();
                isBeforeEnd(n);
                n = n.next) {
               if (n.getValidValue() != null)
                   ++count;
   ...
   static {
       try {
           ...
           //UNSAFE = sun.misc.Unsafe.getUnsafe();
           Class k = MySecondConcurrentSkipListMap.class;
